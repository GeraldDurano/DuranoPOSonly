...
public class Tframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Try our Best Iphones ");

        jLabel12.setText("###");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Iphone 4", "Iphone 4s", "Iphone 5", "Iphone 5s", "Iphone 6", "Iphone 6s", "Iphone 6plus", " " }));
    ...
    public void definePrice(String pprodut){
         if(product.equals("Iphone 4")){
             setPrice(2999d);
        }
         else if(product.equals("Iphone 4s")){
             setPrice(3499d);
         }
         else if(product.equals("Iphone 5")){
             setPrice(4499d);
         }
         else if(product.equals("Iphone 5s")){
             setPrice(4499d);
         }
         else if(product.equals("Iphone 6")){
             setPrice(5000d);
         }
         else if(product.equals("Iphone 6s")){
             setPrice(5999d);
         }
         else if(product.equals("Iphone 6plus")){
             setPrice(6999d);
         }
         else{
             setPrice(0d);
